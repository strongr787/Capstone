...
namespace Capstone
{
    ...
    public sealed partial class RemindersPage : Page
    {
        ...
        {
            List<Reminder> Reminders = new List<Reminder> { new Reminder(), new Reminder(-1, "Reminder Title", System.DateTime.Now, "This is the reminder description. It's really cool and I like how the cards are", false)};
            // TODO database stuff
            return Reminders;
        }
